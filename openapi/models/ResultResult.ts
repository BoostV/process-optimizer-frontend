...
export function ResultResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultResult {
    ...
    return {
        ...
        'models': !exists(json, 'models') ? undefined : ((json['models'] as Array<any>).map(ResultResultModelsFromJSON)),
...
export function ResultResultToJSON(value?: ResultResult | null): any {
    ...
    return {
        ...
        'next': value.next,
        'models': value.models === undefined ? undefined : ((value.models as Array<any>).map(ResultResultModelsToJSON)),
        'extras': value.extras,
    };
}
