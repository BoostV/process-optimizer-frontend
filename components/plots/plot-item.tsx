...
export const PlotItem = ({ id, title, body, width, maxWidth }: PlotItemProps) => {
  ...
  return (
    <>
      ...
      <Typography variant="body2" paragraph={true}>{body.map((b, i) => <Fragment key={i}>{b}<br/></Fragment>)}</Typography>
